...
checkLogin(){
  console.log(this.loginForm.value)
    ...
    else if(this.loginForm.value.username == 'manager' && this.loginForm.value.password == '12345') {
      localStorage.setItem("loggedin",JSON.stringify(this.loginForm.value))
      this.router.navigate(["/manager/home"]);
    }
    else if(this.loginForm.value.username == 'finance' && this.loginForm.value.password == '12345') {
      localStorage.setItem("loggedin",JSON.stringify(this.loginForm.value))
